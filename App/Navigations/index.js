...
const TabStackScreen = () => {
    ...
    >
        ...
        <tabStackStackNavigator.Screen name='InfluencerSearch' component={InfluencerSearch} options={{ title: strings('Search_Influencer'),headerTitleStyle: {
 ...
 <tabStackStackNavigator.Screen name="CampaignSearch" component={CampaignSearch} options={{
        ...
        <tabStackStackNavigator.Screen name='EditProfile' component={EditProfile} options={{ title: strings('Edit_profile'), headerBackTitle: '',headerTitleStyle: {
                fontFamily: metrics.Lato_Bold,
                color: 'rgba(26, 30, 36, 1)',
                fontSize: metrics.text_16,
...
<tabStackStackNavigator.Screen name='Social' component={Social} options={{ title: "",headerTitleStyle: {
             fontFamily: metrics.Lato_Bold,
             color: 'rgba(26, 30, 36, 1)',
             fontSize: metrics.text_16,
             textTransform: 'capitalize'
...
<tabStackStackNavigator.Screen name='SocialProfileSetup' component={SocialProfileSetup} options={{ title: "",headerTitleStyle: {
                fontFamily: metrics.Lato_Bold,
                color: 'rgba(26, 30, 36, 1)',
                fontSize: metrics.text_16,
                textTransform: 'capitalize'
...
<tabStackStackNavigator.Screen name="TransactionHistory" component={TransactionHistory} options={{  title: strings('Your_Transactions'), 
headerBackTitle: null,
headerTitleStyle: {
                fontFamily: metrics.Lato_Bold,
                color: 'rgba(26, 30, 36, 1)',
...
<tabStackStackNavigator.Screen name="BoughtOrders" component={BoughtOrders} options={{  title: strings('Bought_Orders'),
headerBackTitle: null,
headerTitleStyle: {
                fontFamily: metrics.Lato_Bold,
                color: 'rgba(26, 30, 36, 1)',
...
<tabStackStackNavigator.Screen name="ManageAddress" component={ManageAddress} options={{  title: strings('Add_Address'), 
...
headerTitleStyle: {
 ...
 <tabStackStackNavigator.Screen name="UserAddress" component={UserAddress} options={{  title: strings('Manage_Address'), 
        // headerStyle: styles.navBar,
headerBackTitle: null,
headerTitleStyle: {
                fontFamily: metrics.Lato_Bold,
...
const ProductStackScreen = () => (
    <ProductStackNavigator.Navigator >
        <ProductStackNavigator.Screen name='UserStore' component={UserStore} options={{  title: strings('My_Store'), 
        headerStyle: styles.navBar,
headerBackTitle: null,
headerTitleStyle: {
                fontFamily: metrics.Lato_Bold,
  ...
  <ProductStackNavigator.Screen name='UserProducts' component={UserProducts} options={{  title: '', 
headerBackTitle: null,
headerTitleStyle: {
                fontFamily: metrics.Lato_Bold,
                color: 'rgba(26, 30, 36, 1)',
 ...
 <ProductStackNavigator.Screen name='AddProduct' component={AddProduct} options={{  title: strings('Add_Product'), 
headerBackTitle: null,
headerTitleStyle: {
                fontFamily: metrics.Lato_Bold,
                color: 'rgba(26, 30, 36, 1)',
...
const StoreTabStackScreen = () => (
    <StoreStackNavigator.Navigator >
        <StoreStackNavigator.Screen name="StoreTab" component={StoreTab} options={{  title: strings('Store'), 
headerBackTitle: null,
headerTitleStyle: {
                fontFamily: metrics.Lato_Bold,
                color: 'rgba(26, 30, 36, 1)',
...
<myCompaignStack.Screen name="PurchaseCampaign" component={PurchaseCampaign} options={{
        ...
        <myCompaignStack.Screen name='CampaignDetails' component={CampaignDetails} options={{ title: strings('CampaignDetails'), headerTitleStyle: {
                fontFamily: metrics.Lato_Bold,
                color: 'rgba(26, 30, 36, 1)',
                fontSize: metrics.text_16,
                textTransform: 'capitalize'
...
const myApplicationsStackScreen = ({ navigation }) => (
    ...
    >
        ...
        <myCompaignStack.Screen name='CampaignDetails' component={CampaignDetails} options={{ title: strings('CampaignDetails'),
        headerTitleStyle: {
            fontFamily: metrics.Lato_Bold,
            color: 'rgba(26, 30, 36, 1)',
            fontSize: metrics.text_16,
...
const TabScreens = ({ navigation }) => (
    <TabStack.Navigator
        ...
        tabBarOptions={{
            ...
            style: {
                ...
                //----------add this line------------------------//
                height: Platform.OS == 'android' ? metrics.dimen_55 : metrics.dimen_70,
                borderTopWidth: 0.5,
    ...
    >
        ...
        <TabStack.Screen name='NotificationTab' component={NotificationStackScreen} options={{ title: '' }} />
