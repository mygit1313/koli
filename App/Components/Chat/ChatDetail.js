...
import { GiftedChat, Bubble, Actions, Composer, Send, MessageImage, MessageText, Time, Day } from 'react-native-gifted-chat';
      ...
      <View style={styles.mainView}>
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
          ...
          {this.state.userId != null && <GiftedChat
            ...
            bottomOffset={Platform.OS === "ios" && metrics.dimen_28}
