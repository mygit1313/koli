...
class UserProfile extends Component {
  ...
  render() {
    ...
    const { firstName, lastName, userImage, country, bio, instaaccounttype, blockUserstatus, KoliUserFollowerscount, KoliUserFollowingcount,userReviewlist,calculaterating,blogUrl } = store
