...
this.unsubscribe = dynamicLinks().onLink(url => {
  ...
  this.props.HomeStore.setUserLoginID("")
    ...
    this.props.navigation.setOptions({
      ...
      headerLeft: () => (
        <View style={{ marginLeft: metrics.dimen_15 }} >
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.containerTop}>
        ...
        <Image source={images.Homepage} style={{ position: 'absolute', top: 48, left: 0, right: 0, bottom: 0, width: '100%', height: '100%' }} />
        ...
        <View style={{ height:Platform.OS === 'ios'? metrics.dimen_90:metrics.dimen_60 }}></View>
      ...
      {this.renderSection(strings('Paid_Post'), 'paid', compaignsListPaid)} 
  ...
  logAnalyticsEvent = async (campaignData) => {
